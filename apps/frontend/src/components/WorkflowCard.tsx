    ...
    <div className="card-modern p-6 group hover-lift">
      ...
      <div className="grid grid-cols-3 gap-3 mb-4 text-sm">
        <div className="text-center p-2 rounded-lg bg-white/5">
          <div className="font-bold text-blue-400">{workflow.trigger_type}</div>
          <div className="text-xs text-white/40">Trigger</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-white/5">
          <div className="font-bold text-purple-400">{workflow.node_count}</div>
          <div className="text-xs text-white/40">Nodes</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-white/5">
          <div className="font-bold text-green-400">{workflow.integrations.length}</div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-1">
            ...
            {workflow.integrations.length > 4 && (
              <span className="px-2 py-1 rounded-md bg-white/5 text-white/40 text-xs font-medium border border-white/10">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="p-2 rounded-lg border-2 border-white/5 hover:border-blue-500 hover:bg-blue-500/10 transition-all text-white/60 hover:text-white"
        >
